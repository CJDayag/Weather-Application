...
WEATHER_API_KEY = os.getenv('WEATHER_API')  # Add to your environment variables
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'frontend', 'dist') if os.path.exists(os.path.join(BASE_DIR, 'frontend', 'dist')) else None,
]
...
LOGGING = {
    ...
    'loggers': {
        'weather': {  # This will catch all loggers in the weather app
            'handlers': ['console'],
            'level': 'DEBUG',
            'propagate': True,
        },
...
# Filter out None values from STATICFILES_DIRS
STATICFILES_DIRS = list(filter(None, STATICFILES_DIRS))
